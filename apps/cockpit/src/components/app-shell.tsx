...
const NAV_TOP = [
  ...
  { href: "/productions", label: "In production", Icon: IconFilm, match: (p: string) => p.startsWith("/productions") },
  { href: "/gates", label: "Review", Icon: IconReview, match: (p: string) => p.startsWith("/gates") || p.startsWith("/alerts") },
  ...
  { href: "/audio", label: "Audio library", Icon: IconAudio, match: (p: string) => p.startsWith("/audio") },
];
const NAV_SOON = [
